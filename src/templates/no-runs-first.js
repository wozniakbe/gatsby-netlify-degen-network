...
const Pagination = (props) => (
  <div className="pagination -post">
    <ul>
        {(props.previous && props.previous.frontmatter.template === 'no-runs-first') && (
          <li>
        ...
        {(props.next && props.next.frontmatter.template === 'no-runs-first') && (
          <li>
...
const NoRunsFirstPost = ({ data, pageContext }) => {
  ...
  return (
    <Layout className="page">
      <SEO
        ...
        article={true}
      />
      <article className="no-runs-first">
...
export default NoRunsFirstPost

export const pageQuery = graphql`
  query NoRunsFirstQuery($id: String!) {
    markdownRemark( 
      id: { eq: $id }
    ) {
      id
