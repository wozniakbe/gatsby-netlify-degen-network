...
const Pagination = (props) => (
  <div className="pagination -post">
    <ul>
        {(props.previous && props.previous.frontmatter.template === 'daily-picks') && (
          <li>
        ...
        {(props.next && props.next.frontmatter.template === 'daily-picks') && (
          <li>
...
const DailyPicks = ({ data, pageContext }) => {
...
export const pageQuery = graphql`
  query DailyPicksQuery($id: String!) {
    markdownRemark( 
      id: { eq: $id }
    ) {
      id
